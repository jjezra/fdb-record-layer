...
public class ThrottledRetryingIterator<T> implements AutoCloseable {
    ...
    public static class Builder<T> {
         ...
         * Anything that this callback writes to the given store is committed (or rolled back) with the range that was
         * just iterated.
         * Defaults to null (no callback).
         * @param transactionPreCommitHook the callback invoked every time a transaction is about to be committed
         * @return this builder
         */
        public Builder<T> withTransactionPreCommitHook(Function<FDBRecordStore, CompletableFuture<Void>> transactionPreCommitHook) {
